...
RSpec.describe 'User show method ', type: :feature do
  before(:example) do
    ...
    @posts = [Post.create(
      ...
      likes_count: 0
              ...
              Post.create(author: @user, title: 'Hey', content: 'This is my second post', commentsCounter: 0,
                          likes_count: 0),
              Post.create(author: @user, title: 'What\'s up', content: 'This is my third post', commentsCounter: 0,
                          likes_count: 0)]
  ...
  it 'redirects to the clicked post link' do
    post = @posts.first
